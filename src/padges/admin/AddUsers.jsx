...
function AddUsers() {
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <form
        onSubmit={add}
        className=" p-5  md:w-auto border-solid border-2  rounded-lg bg-[#4F5D73] flex flex-col gap-y-4 text-white  ">
        {/* titl & price & catgre */}
          ...
          <div className="relative">
            ...
            {show ? (
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-5 absolute bottom-2 right-1 text-black">
                <path
                  strokeLinecap="round"
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-5 absolute bottom-3 right-1 text-black">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
